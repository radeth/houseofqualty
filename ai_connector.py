...
# product_description = "Standardowy odkurzacz przewodowy"
# client_requirements = ["Niezawodność", "poręczność", "zwijacz kabla", "niska cena"]
# technical_parameters = ["Moc silnika", "Kolorystyka", "Masa", "wymiary"]
# data = get_req_parm_matrix_from_ai(product_name, product_description, client_requirements, technical_parameters)
# sleep(1)
